// FacelessForge verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'facelessforge-pepper-eb60e22c';

const FILES = [
  'forge-system.pdf', 'niche-finder.pdf', 'script-factory.pdf', 'voiceover-pack.pdf',
  'thumbnail-kit.pdf', 'batch-playbook.pdf', 'publishing-tracker.pdf', 'monetization-cheatsheet.pdf',
];
